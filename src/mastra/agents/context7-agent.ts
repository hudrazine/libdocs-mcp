		...
		.array(
			z.object({
				...
				trustScore: z
					...
					.max(10)
					.optional()
					.describe("Library trust score (0-10, higher is more authoritative)"),
				snippetCount: z.number().int().min(0).optional().describe("Number of available code snippets for this library"),
			}),
		)
		.default([])
		.transform((entries) => {
